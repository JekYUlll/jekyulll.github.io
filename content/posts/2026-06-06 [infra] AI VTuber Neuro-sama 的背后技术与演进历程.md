...
很多人以为 Neuro-sama 就是一个 LLM 在说话。实际上她是一套多模型管线。

![Neuro-sama 技术架构：多模型 AI 管线](images/neuro-architecture.png "Neuro-sama 系统架构")
...
*图片来源：Neuro-sama V3 角色图来自 [NeuroWiki](https://en.neurosama.info/wiki/Neuro-sama)（CC BY-NC-SA），架构图基于 NeuroWiki 及 [LLM Agent Research](https://lin-guanguo.github.io/llm-memory-research/neuro-sama.research/) 数据自制。*
